  ...
  return (
    <div
      className="absolute right-6 top-5 bottom-0 w-[55%] bg-white rounded-t-[22px] overflow-hidden
                 grid grid-cols-2 grid-rows-2 gap-2.5 p-3.5 z-10"
      style={{
    ...
    >
      ...
      <div className="rounded-2xl bg-[#F9F7F2] border-2 border-dashed border-[#E0D8CC]
        ...
        <span className="text-[52px] font-black leading-none text-text-head" style={{ fontFamily: 'Georgia, serif' }}>T</span>
        <div className="flex flex-col items-center gap-1 mt-1">
          <div className="w-9 h-[3px] bg-accent rounded-full" />
          <span className="text-[7px] font-bold text-text-muted tracking-[2px] uppercase" style={{ fontFamily: 'monospace' }}>
            Type
          </span>
        </div>
      ...
      <div className="rounded-2xl bg-[#F4F2EC] flex flex-col items-center justify-center gap-3 p-3">
        ...
        <div className="w-12 h-6 rounded-full flex items-center px-1 justify-end"
          ...
          <div className="w-[18px] h-[18px] bg-white rounded-full" style={{ boxShadow: '0 1px 3px rgba(0,0,0,.25)' }} />
        </div>
        {/* Slider */}
